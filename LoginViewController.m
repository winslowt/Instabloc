...
- (void)viewDidLoad {
    ...
    self.title = NSLocalizedString(@"Login", @"Login");
     ...
     NSString *urlString = [NSString stringWithFormat:@"https://instagram.com/oauth/authorize/?client_id=%@&scope=likes+comments+relationships&redirect_uri=%@&response_type=token", [DataStores instagramClientID], [self redirectURI]];
