...
- (void)viewDidLoad {
    ...
    //registering default classes for the cell
    
    self.collectionView.backgroundColor = [UIColor whiteColor];
    //setting a backgroundcolor
...
//Once the user authorizes, we load the assets and reload the collection view on the main thread. If the user has already authorized, we just load the assets: there's no need to reload.^^
